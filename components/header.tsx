...
export default function Header() {
    ...
    return (
        ...
        <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-xl shadow-lg border-b border-black/5'
                ...
                <div className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className={`w-10 h-10 lg:w-12 lg:h-12 rounded-xl flex items-center justify-center transition-all duration-300 ${scrolled ? 'bg-gradient-to-br from-[var(--color-earth)] to-[var(--color-gold)] shadow-lg'
                        ...
                        <nav className="hidden lg:flex items-center gap-1">
                            ...
                            {navLinks.map((link) => (
                                ...
                                <Link
                                    ...
                                    className={`relative flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium text-sm transition-all ${isActive(link.href) ? 'text-[var(--color-earth)] bg-[var(--color-earth)]/5'

                                        : scrolled ? 'text-[var(--color-text-secondary)] hover:text-[var(--color-earth)] hover:bg-[var(--color-cream-dark)]'
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {isAuthenticated ? (
                            ...
                            <>
                                ...
                                {profile && (
                                    <div className={`hidden sm:flex items-center gap-1.5 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-xl font-medium text-xs sm:text-sm transition-all ${profile.credits !== -1 && profile.credits < 5 ? 'bg-red-50 border border-red-200 text-red-600 animate-pulse'

                                        : scrolled ? 'bg-gradient-to-r from-[var(--color-gold)]/10 to-[var(--color-terracotta)]/10 border border-[var(--color-gold)]/20 text-[var(--color-earth)]'
                                ...
                                <div className="relative" ref={dropdownRef}>
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 p-1.5 rounded-xl transition-all ${scrolled ? 'hover:bg-[var(--color-cream-dark)]'
                                    ...
                                    >
                                        ...
                                        <div className={`relative w-9 h-9 lg:w-10 lg:h-10 rounded-xl overflow-hidden transition-all ${profile?.plan === 'pro' ? 'ring-2 ring-[var(--color-gold)] ring-offset-2 ring-offset-white'
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${profile?.plan === 'pro' ? 'bg-[var(--color-gold)]/10 text-[var(--color-gold)]'

                                                                : profile?.plan === 'starter' ? 'bg-[var(--color-savanna)]/10 text-[var(--color-savanna)]'
                                ...
                                <button
                                    ...
                                    className={`lg:hidden p-2 rounded-xl transition-all ${scrolled ? 'hover:bg-[var(--color-cream-dark)] text-[var(--color-text-primary)]'
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link
                                    ...
                                    className={`px-4 py-2 rounded-xl font-medium text-sm transition-all ${scrolled ? 'text-[var(--color-earth)] hover:bg-[var(--color-cream-dark)]'
                        ...
                        <div className="space-y-2">
                            ...
                            {navLinks.map((link) => (
                                ...
                                <Link
                                    ...
                                    className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${isActive(link.href) ? 'text-[var(--color-earth)] bg-[var(--color-earth)]/5'
