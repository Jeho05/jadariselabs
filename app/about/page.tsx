    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-cream)]">
      ...
      <main className="flex-1 pt-28 md:pt-32">
        ...
        <section className="relative z-10 px-6 md:px-12 lg:px-16 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-6 mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
              L&apos;IA, <span className="text-gradient-animated">faite pour nous, par nous</span>
            </h1>
        ...
        <section className="relative z-10 px-6 py-14 md:px-12 lg:px-16">
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-3xl border border-[var(--color-border)] shadow-sm p-8 md:p-12">
        ...
        <section className="relative z-10 px-6 py-14 md:px-12 lg:px-16">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-12" style={{ fontFamily: 'var(--font-heading)' }}>
              Ce qui nous <span className="text-gradient-animated">anime</span>
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {VALUES.map((value) => (
                <div key={value.title} className="bg-white rounded-2xl border border-[var(--color-border)] p-6 shadow-sm">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--color-cream-dark)] flex items-center justify-center mb-4">
                    <value.icon size={24} className="text-[var(--color-earth)]" />
                  </div>
        ...
        <section className="relative z-10 px-6 py-14 md:px-12 lg:px-16">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-12" style={{ fontFamily: 'var(--font-heading)' }}>
              Notre <span className="text-gradient-animated">parcours</span>
            </h2>
            <div className="relative border-l-2 border-[var(--color-cream-dark)] ml-4 space-y-8">
              {MILESTONES.map((milestone, i) => (
                <div key={i} className="relative pl-8">
                  <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-[var(--color-gold)] ring-4 ring-white shadow" />
                  <div className="bg-white rounded-2xl border border-[var(--color-border)] p-5 shadow-sm">
                    <span className="inline-flex items-center gap-1 text-xs font-bold text-[var(--color-earth)] bg-[var(--color-cream-dark)]/60 px-3 py-1 rounded-full mb-2">
                      <IconAward size={12} />
                      {milestone.year}
                    </span>
        ...
        <section className="relative z-10 px-6 py-14 md:px-12 lg:px-16">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
              L&apos;équipe <span className="text-gradient-animated">derrière le lab</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {TEAM.map((member) => (
                <div key={member.name} className="bg-white rounded-2xl border border-[var(--color-border)] p-8 shadow-sm text-center">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[var(--color-gold)] to-[var(--color-terracotta)] flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4 ring-4 ring-[var(--color-cream)]">
                    {member.initials}
                  </div>
                  <h3 className="text-lg font-bold">{member.name}</h3>
                  <p className="text-sm font-semibold text-[var(--color-earth)] mb-3">{member.role}</p>
                  <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed">
                    {member.bio}
                  </p>
                </div>
            ...
            <div className="relative bg-[var(--color-earth-dark)] rounded-[2rem] p-10 md:p-16 text-center overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  ...
                  <a href="/features" className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-semibold border-2 border-white/30 text-white hover:bg-white/10 transition-all">
